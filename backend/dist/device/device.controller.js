...
let DeviceController = class DeviceController {
    ...
    getDevice(socketId) {
        ...
        if (!device) {
            throw new common_1.NotFoundException(`Dispositivo con socket ID "${socketId}" no encontrado`);
        }
        return device;
    }
};
...
], DeviceController.prototype, "getCount", null);
__decorate([
    (0, common_1.Get)('origen/:origen'),
    __param(0, (0, common_1.Param)('origen')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Array)
], DeviceController.prototype, "getByOrigin", null);
__decorate([
    (0, common_1.Get)(':socketId'),
